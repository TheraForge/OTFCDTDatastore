...
DEFAULT_TARGET = "OTFCDTDatastore.framework"
...
def usage
  <<~USAGE
    Usage:
      ...
      ruby Scripts/generate_coverage_badge.rb /tmp/coverage.xcresult
      ruby Scripts/generate_coverage_badge.rb /tmp/coverage.xcresult --target #{DEFAULT_TARGET} --output badges/coverage.svg
